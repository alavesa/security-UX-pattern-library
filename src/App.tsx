...
import { AIHumanOverridePattern } from "./patterns/ai/AIHumanOverridePattern";
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route path="patterns/ai/human-override" element={<PatternPage><AIHumanOverridePattern /></PatternPage>} />
